const Footer = () => {
    return (
        <div className='text-gray-300 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 bg-black'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div>
                    <p className='text-lg text-gray-500 font-semibold'>COMPANY</p>
                ...
                <div>
                    <p className='text-lg text-gray-500 font-semibold'>SUPPORT</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                ...
                <div className='max-w-80'>
                    <p className='text-lg text-gray-500 font-semibold'>STAY UPDATED</p>
